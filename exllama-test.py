...
# Read prompts
parser.add_argument("-lang", type = str, default = 'ja', help = "Either 'en' or ja'")
...
# Namespace(eval_dataset=None, eval_rows=128, eval_length=2048, eval_token=False, eval_token_8bit=False, prompt=None, tokens=128, prompt_speed=False, speed=False, model_dir=None, gpu_split=None, length=None, rope_scale=1.0, rope_alpha=1.0, no_flash_attn=False, low_mem=False)
args.eval_length=1024
args.tokens=512
...
if args.prompt:
    ...
    print(f" -- Response generated in {total_gen:.6f} seconds, {args.tokens} tokens, {args.tokens / total_gen:.2f} tokens/second (includes prompt eval.)")
