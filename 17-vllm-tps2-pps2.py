...
model_name = "TheBloke/shisa-7B-v1-AWQ"


with time_block("Load Tokenizer"):
    tokenizer = AutoTokenizer.from_pretrained(model_name, use_fast=True, quantization='awq')


with time_block("Load Model"):
    model = LLM(model=model_name, tensor_parallel_size=2, pipeline_parallel_size=2)
